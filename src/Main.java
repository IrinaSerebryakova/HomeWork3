public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("За 20 минут машина произвела "
                            + machineCapacityPer20Minutes + " штук бутылок.");

        System.out.println("За сутки машина произвела "
                            + machineCapacityPerDay + " штук бутылок.");

        System.out.println("За 3 дня машина произвела "
                            + machineCapacityPer3Days + " штук бутылок.");

        System.out.println("За 1 месяц машина произвела "
                            + machineCapacityPerMonth + " штук бутылок.\n");
        ...
        System.out.println("В школе, где " + countOfClassRooms + " классов, нужно "
        ...
        float totalWeightOfBreakfastInGrams = (countOfBananas * weightOfBanana) +
                                              (countOfMilk * weightOf100MlMilk) +
                                              (countOfIceCream * weightOfIceCream) +
                                              (countOfRawEgg * weightOfRawEgg);

        float totalWeightOfBreakfastInKilos = totalWeightOfBreakfastInGrams / 1000;

        System.out.println("Общий вес спортивного завтрака составляет " +
                            totalWeightOfBreakfastInGrams + " грамм(ов) или " +
                            totalWeightOfBreakfastInKilos + " килограмм(ов).\n");
        ...
        System.out.println(daysOfVarDiet1 + " день (дней) уйдет на то, чтобы сбросить " +
                            overWeightInKilos + " килограммов, если спортсмен" +
                            "будет терять каждый день по 250 грамм.");

        System.out.println(daysOfVarDiet2 + " день (дней) уйдет на то, чтобы сбросить " +
                            overWeightInKilos + " килограммов, если спортсмен" +
                            "будет терять каждый день по 500 грамм.");

        System.out.println("В среднем может потребоваться " +
                            averageNumberOfDays + " день (дней)," +
        ...
        System.out.println("Маша теперь получает " + newSalaryOfEmployeeMaria +
                              " рублей. Годовой доход вырос на " +
                              differenceSalaryToMaria + " рублей.");

        System.out.println("Денис теперь получает " + newSalaryOfEmployeeDenis +
                              " рублей. Годовой доход вырос на " +
                              differenceSalaryToDenis + " рублей.");

        System.out.println("Кристина теперь получает " + newSalaryOfEmployeeKristina +
                              " рублей. Годовой доход вырос на " +
                              differenceSalaryToKristina + " рублей.");
